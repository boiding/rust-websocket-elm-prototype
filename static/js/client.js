...
var _boiding$rust_websocket_elm_prototype$Main$update = F2(
...
var _boiding$rust_websocket_elm_prototype$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: A2(_elm_lang$websocket$WebSocket$listen, model.address, _boiding$rust_websocket_elm_prototype$Main$Receive),
			_1: {
				ctor: '::',
				_0: _boiding$rust_websocket_elm_prototype$Main$websocket_address(_boiding$rust_websocket_elm_prototype$Main$Address),
				_1: {ctor: '[]'}
			}
		});
};
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$disabled(!allowed_to_decrement),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(_boiding$rust_websocket_elm_prototype$Main$Decrement),
						_1: {ctor: '[]'}
					}
				},
				{
			...
			_1: {
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onClick(_boiding$rust_websocket_elm_prototype$Main$Increment),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
...
var _boiding$rust_websocket_elm_prototype$Main$main = _elm_lang$html$Html$program(
	{init: _boiding$rust_websocket_elm_prototype$Main$init, view: _boiding$rust_websocket_elm_prototype$Main$view, update: _boiding$rust_websocket_elm_prototype$Main$update, subscriptions: _boiding$rust_websocket_elm_prototype$Main$subscriptions})();

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _boiding$rust_websocket_elm_prototype$Main$main !== 'undefined') {
    _boiding$rust_websocket_elm_prototype$Main$main(Elm['Main'], 'Main', undefined);
}
